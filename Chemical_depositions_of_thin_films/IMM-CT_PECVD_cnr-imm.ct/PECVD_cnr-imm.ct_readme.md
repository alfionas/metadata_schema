# PECVD Data Processing Pipeline

This file describes the pipeline to produce Nomad ELN for Plasma Enhanced Chemical Vapor Deposition (PECVD) synthesis performed in IMM-CT unit of NFFA-DI. 
...
- `PECVD_cnr-imm.ct_readme.md`: This file. Describes the Data Processing Pipeline.
- `PECVD_cnr-imm.ct_ELN.archive.json`: Example Nomad ELN for a PECVD process.
- `PECVD_cnr-imm.ct_equipment.archive.json`: Example equipment entry for PECVD, and entry for PECVD equipment at Catania IMM.
