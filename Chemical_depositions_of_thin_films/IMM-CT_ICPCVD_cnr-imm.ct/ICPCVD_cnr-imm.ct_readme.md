# ICPCVD Data Processing Pipeline

This file describes the pipeline to produce Nomad ELN for Inductively Coupled Plasma Chemical Vapor Deposition (ICPCVD) synthesis performed in IMM-CT unit of NFFA-DI. 
...
- `ICPCVD_cnr-imm.ct_readme.md`: This file. Describes the Data Processing Pipeline.
- `ICPCVD_cnr-imm.ct_ELN.archive.json`: Example Nomad ELN for a ICPCVD process.
- `ICPCVD_cnr-imm.ct_equipment.archive.json`: Example equipment entry for ICPCVD, and entry for ICPCVD equipment at Catania IMM.
