# LA PECVD Data Processing Pipeline

This file describes the pipeline to produce Nomad ELN for Large Area Plasma Enhanced Chemical Vapor Deposition (LA PECVD) synthesis performed in IMM-CT unit of NFFA-DI. 
...
- `LA PECVD_cnr-imm.ct_readme.md`: This file. Describes the Data Processing Pipeline.
- `LA PECVD_cnr-imm.ct_ELN.archive.json`: Example Nomad ELN for a LA PECVD process.
- `LA PECVD_cnr-imm.ct_equipment.archive.json`: Example equipment entry for LA PECVD, and entry for LA PECVD equipment at Catania IMM.
